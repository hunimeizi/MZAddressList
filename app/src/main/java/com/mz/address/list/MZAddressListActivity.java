...
import com.mz.address.list.itemAnimator.SlideInOutLeftItemAnimator;
import com.mz.address.list.utils.CommonUtil;

import java.util.ArrayList;
import java.util.List;

public class MZAddressListActivity extends BaseActivity {
